"""Ejercicio 3. Crea un programa que muestre por pantalla el
nombre y el precio final de todos los juegos suponiendo un IVA
del 21% y que no hay descuentos. """
...
for juego in juegos:
    print(juego.nombre, "-> El precio final es: ", juego.precio_final(0.21, 0))