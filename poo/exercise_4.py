"""Ejercicio 4. Es el festival de los juegos RPG.
Crea un programa que muestre por pantalla el nombre y
el precio final de todos los juegos suponiendo un IVA
del 21% y teniendo SOLO los juegos cuyo género sea RPG
un descuento del 25%."""
...
for juego in juegos:
    ...
    if "RPG" in juego.generos:
        descuento = 0.25
    print(juego.nombre, "-> El precio final es: ", juego.precio_final(0.21, descuento))