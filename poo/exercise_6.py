"""Ejercicio 6. Dada la clase Planeta crea una lista que contenga
los siguientes planetas:
Cuando el planeta se conoce desde la antigüedad utiliza datetime.min
 que representa la menor fecha posible
"""
