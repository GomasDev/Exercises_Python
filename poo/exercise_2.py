"""Ejercicio 2. Crea una segunda lista que contenga solo los
juegos para menores, que tengan una puntuación de 9 o más y
pesen menos 50 GB."""
...
juegos_top = [juego for juego in juegos if juego.apto_menores() and juego.puntuacion>=9 and juego.peso < 50]
